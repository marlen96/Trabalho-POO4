  ...
  <thead>
      ...
      <th scope="col">Descrição</th>
		...
		<c:forEach var="i" items="${TipoDeVacinaController.getInstance().buscarTodos()}">
			<tr>
				...
				<td><a href="./controller?acao=deletarDeVacina&id=${i.id}" class="btn btn-lg btn-info">Deletar</a>
	...
	<div class="form-group">
		<div class="col-sm-offset-3 col-sm-10">
		    <a href="cadastrarTipoVacina.jsp" class="btn btn-lg btn-warning">Cadastrar Novo</a>
