...
<div class="container" style="padding-top: 20px;">
	...
	<form class="form-horizontal" method="post" data-toggle="validator"
		role="form" action="EditarProdutoServicoVendaServicoSucesso.jsp">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="nquantidade" name="nquantidade"
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="vendaprod" name="nvendaprod"
					placeholder="" required 
